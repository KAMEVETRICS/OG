  ...
  return (
    <main className="passport-shell certification-shell">
      ...
      <section className="certification-intro" aria-labelledby="certification-title">
        ...
        <p>
          Prove ownership, lock one implementation package, and run every policy case on 0G Compute with Router TEE provenance. Passing evidence is committed before the issuer can write a seal.
        </p>
        <div className="certification-constraints" aria-label="Certification requirements">
          <span>15 CASES</span><span>45 ROUTER RUNS</span><span>100% REQUIRED</span><span>7-DAY SEAL</span>
        </div>
      </section>
